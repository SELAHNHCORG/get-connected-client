...
try:
    import typer
except ImportError as error:  # pragma: no cover - exercised in an isolated env
    raise SystemExit(
        "The galaxy CLI requires the optional cli dependencies.\n"
        "Install them with:  pip install 'get-connected-client[cli]'"
    ) from error
