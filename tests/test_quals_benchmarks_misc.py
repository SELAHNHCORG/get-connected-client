...
from get_connected_client.models.auth import LoginResult
from get_connected_client.models.benchmarks import Benchmark
...
from get_connected_client.models.qualifications import Qualification, QualificationUser
from get_connected_client.models.users import User, UserOneclick
from get_connected_client.resources.auth import Auth
from get_connected_client.resources.benchmarks import Benchmarks
...
def test_auth_login_without_any_key_raises(monkeypatch, api):
    ...
    from get_connected_client.exceptions import MissingAPIKeyError
